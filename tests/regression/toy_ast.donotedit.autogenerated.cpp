...
) + "(") + std::to_string([&]() -> decltype(auto) { static_assert(((!std::is_reference_v<decltype((*ceto::mad(this -> args)).size())> ) && true)); return (*ceto::mad(this -> args)).size(); }())) + " args.)\n") } ;
...
struct Identifier : public Node {
    ...
    auto main() -> int {
        ...
        std::cout << (*ceto::mad(static_pointer_cast<std::type_identity_t<ceto::propagate_const<std::shared_ptr<const Identifier>>> :: element_type>(id_node))).name;
