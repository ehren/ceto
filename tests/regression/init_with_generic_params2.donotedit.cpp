...
struct Foo : public ceto::shared_object, public std::enable_shared_from_this<Foo> {
    ...
    auto main() -> int {
        const auto f1 = ceto::make_shared_nonullpropconst<const Foo>();
        const auto f2 = ceto::make_shared_nonullpropconst<const Foo>(1);
        const auto f3 = ceto::make_shared_nonullpropconst<const Foo>(2, 3);
