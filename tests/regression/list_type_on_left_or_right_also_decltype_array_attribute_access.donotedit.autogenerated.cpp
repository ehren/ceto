...
struct Foo : public ceto::shared_object, public std::enable_shared_from_this<Foo> {
    ...
    auto main() -> int {
        ...
        for(const auto& l : std::vector {{l1, l2, l3}}) {
            (*ceto::mad(lm)).push_back(ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(l,0))).a,2));
            (*ceto::mad(lm2)).push_back(ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(l3,0))).a,2));
            const auto a = ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(l1,0))).a,2);
            (*ceto::mad(lm3)).push_back(a);
            const auto b = ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(l,0))).a,2);
        ...
        (((((std::cout << ceto::maybe_bounds_check_access(lm,0)) << ceto::maybe_bounds_check_access(lm2,0)) << ceto::maybe_bounds_check_access(lm4,0)) << ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(lm7,0))).a,0)) << ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(lm8,0))).b,1)) << ceto::maybe_bounds_check_access((*ceto::mad(ceto::maybe_bounds_check_access(lm9,0))).c,2);
    }
