    ...
    std::weak_ptr<const Node> _parent = {};
        ...
        inline auto cloned_args() const -> std::vector<std::shared_ptr<const Node>> {
         ...
         virtual inline auto clone() const -> std::shared_ptr<Node> {
            ...
            auto c { std::make_shared<Node>([&]() {if (this -> func) {
...
struct UnOp : public Node {
    ...
    std::string op;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<UnOp>(this -> op, this -> cloned_args(), source) } ;
            return c;
        }
...
struct LeftAssociativeUnOp : public Node {
    ...
    std::string op;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<LeftAssociativeUnOp>(this -> op, this -> cloned_args(), source) } ;
            return c;
        }
...
struct BinOp : public Node {
    ...
    std::string op;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<BinOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<TypeOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using TypeOp::TypeOp;
    ...
    std::shared_ptr<const Node> synthetic_lambda_return_lambda = nullptr; static_assert(ceto::is_non_aggregate_init_and_if_convertible_then_non_narrowing_v<decltype(nullptr), std::remove_cvref_t<decltype(synthetic_lambda_return_lambda)>>);
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<SyntaxTypeOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<AttributeAccess>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<ArrowOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<ScopeResolution>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<Assign>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Assign::Assign;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<NamedParameter>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<BitwiseOrOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using BinOp::BinOp;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<EqualsCompareOp>(this -> op, this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Node::Node;
    ...
    decltype(false) is_one_liner_if = false;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<Call>((*ceto::mad(this -> func)).clone(), this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Node::Node;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<ArrayAccess>((*ceto::mad(this -> func)).clone(), this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Node::Node;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<BracedCall>((*ceto::mad(this -> func)).clone(), this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Node::Node;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<Template>((*ceto::mad(this -> func)).clone(), this -> cloned_args(), this -> source) } ;
            return c;
        }
...
struct StringLiteral : public Node {
 ...
 + this -> escaped()) + [&]() {if (this -> suffix) {
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<StringLiteral>(this -> str, [&]() {if (this -> prefix) {
...
struct IntegerLiteral : public Node {
    ...
    std::shared_ptr<const Identifier> suffix;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<IntegerLiteral>(this -> integer_string, [&]() {if (this -> suffix) {
                return std::dynamic_pointer_cast<const Identifier>((*ceto::mad(this -> suffix)).clone());
            } else {
                return (this -> suffix);
            }}()
...
struct FloatLiteral : public Node {
    ...
    std::shared_ptr<const Identifier> suffix;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<FloatLiteral>(this -> float_string, [&]() {if (this -> suffix) {
                return std::dynamic_pointer_cast<const Identifier>((*ceto::mad(this -> suffix)).clone());
            } else {
                return (this -> suffix);
            }}()
...
struct ListLike_ : public Node {
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<ListLike_>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using ListLike_::ListLike_;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<ListLiteral>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using ListLike_::ListLike_;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<TupleLiteral>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using ListLike_::ListLike_;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<BracedLiteral>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using ListLike_::ListLike_;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<Block>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
using Block::Block;
    ...
    decltype(false) has_main_function = false;
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<Module>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
struct RedundantParens : public Node {
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<RedundantParens>(this -> cloned_args(), this -> source) } ;
            return c;
        }
...
struct InfixWrapper_ : public Node {
        ...
        inline auto clone() const -> std::shared_ptr<Node> override {
            auto c { std::make_shared<InfixWrapper_>(this -> cloned_args(), this -> source) } ;
            return c;
        }
    ...
    inline auto gensym() -> auto {
        ...
        const auto s = std::make_shared<const Identifier>("ceto__private__ident__" + std::to_string(counter));
        counter += 1;
        return s;
    }
