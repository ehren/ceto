...
;
struct ClassDefinition : ceto::shared_object, std::enable_shared_from_this<ClassDefinition> {
...
struct VariableDefinition : ceto::shared_object, std::enable_shared_from_this<VariableDefinition> {
...
struct Scope : ceto::shared_object, std::enable_shared_from_this<Scope> {
