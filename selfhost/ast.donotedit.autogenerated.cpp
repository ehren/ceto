...
[]( auto &&  m) {
        ...
        auto node { (*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad(py::class_<Node,std::shared_ptr<Node>>(m, "Node"))).def_readwrite("func", (&Node::func)))).def_readwrite("args", (&Node::args)))).def_readwrite("declared_type", (&Node::declared_type)))).def_readwrite("scope", (&Node::scope)))).def_readwrite("source", (&Node::source)))).def("__repr__", (&Node::repr)))).def("ast_repr", [](const Node&  n, const bool  preserve_source_loc, const bool  ceto_evalable) {
        ...
        (*ceto::mad((*ceto::mad(py::class_<UnOp,std::shared_ptr<UnOp>>(m, "UnOp", node))).def(py::init<const std::string &,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("op"), py::arg("args"), py::arg("source") = std::make_tuple("", 0)))).def_readwrite("op", (&UnOp::op));
        (*ceto::mad((*ceto::mad(py::class_<LeftAssociativeUnOp,std::shared_ptr<LeftAssociativeUnOp>>(m, "LeftAssociativeUnOp", node))).def(py::init<const std::string &,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("op"), py::arg("args"), py::arg("source") = std::make_tuple("", 0)))).def_readwrite("op", (&LeftAssociativeUnOp::op));
        auto binop { py::class_<BinOp,std::shared_ptr<BinOp>>(m, "BinOp", node) } ;
        (*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad(binop)).def(py::init<const std::string &,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("op"), py::arg("args"), py::arg("source") = std::make_tuple("", 0)))).def_readwrite("op", (&BinOp::op)))).def_property_readonly("lhs", (&BinOp::lhs)))).def_property_readonly("rhs", (&BinOp::rhs));
        auto typeop { py::class_<TypeOp,std::shared_ptr<TypeOp>>(m, "TypeOp", binop) } ;
        (*ceto::mad(typeop)).def(py::init<const std::string &,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("op"), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        ...
        (*ceto::mad((*ceto::mad(py::class_<Call,std::shared_ptr<Call>>(m, "Call", node))).def(py::init<std::shared_ptr<const Node>,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("func"), py::arg("args"), py::arg("source") = std::make_tuple("", 0)))).def_readwrite("is_one_liner_if", (&Call::is_one_liner_if));
        (*ceto::mad(py::class_<ArrayAccess,std::shared_ptr<ArrayAccess>>(m, "ArrayAccess", node))).def(py::init<std::shared_ptr<const Node>,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("func"), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<BracedCall,std::shared_ptr<BracedCall>>(m, "BracedCall", node))).def(py::init<std::shared_ptr<const Node>,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("func"), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<Template,std::shared_ptr<Template>>(m, "Template", node))).def(py::init<std::shared_ptr<const Node>,std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("func"), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<Identifier,std::shared_ptr<Identifier>>(m, "Identifier", node))).def(py::init<const std::string &,std::tuple<std::string,int>>(), py::arg("name"), py::arg("source") = std::make_tuple("", 0));
        ...
        (*ceto::mad((*ceto::mad((*ceto::mad(py::class_<FloatLiteral,std::shared_ptr<FloatLiteral>>(m, "FloatLiteral", node))).def(py::init<const std::string &,std::shared_ptr<const Identifier>,std::tuple<std::string,int>>(), py::arg("float_string"), py::arg("suffix"), py::arg("source") = std::make_tuple("", 0)))).def_readonly("float_string", (&FloatLiteral::float_string)))).def_readonly("suffix", (&FloatLiteral::suffix));
        auto list_like { py::class_<ListLike_,std::shared_ptr<ListLike_>>(m, "ListLike_", node) } ;
        (*ceto::mad(py::class_<ListLiteral,std::shared_ptr<ListLiteral>>(m, "ListLiteral", list_like))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<TupleLiteral,std::shared_ptr<TupleLiteral>>(m, "TupleLiteral", list_like))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<BracedLiteral,std::shared_ptr<BracedLiteral>>(m, "BracedLiteral", list_like))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        auto block { py::class_<Block,std::shared_ptr<Block>>(m, "Block", list_like) } ;
        (*ceto::mad(block)).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad((*ceto::mad(py::class_<Module,std::shared_ptr<Module>>(m, "Module", block))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0)))).def_readwrite("has_main_function", (&Module::has_main_function));
        (*ceto::mad(py::class_<RedundantParens,std::shared_ptr<RedundantParens>>(m, "RedundantParens", node))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
        (*ceto::mad(py::class_<InfixWrapper_,std::shared_ptr<InfixWrapper_>>(m, "InfixWrapper_", node))).def(py::init<std::vector<std::shared_ptr<const Node>>,std::tuple<std::string,int>>(), py::arg("args"), py::arg("source") = std::make_tuple("", 0));
