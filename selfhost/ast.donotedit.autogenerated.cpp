...
using namespace pybind11::literals;
        ...
        auto node { ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(py::class_<Node,std::shared_ptr<Node>>(m, "Node", py::dynamic_attr()))->def_readwrite("func", (&Node::func)))->def_readwrite("args", (&Node::args)))->def_readwrite("declared_type", (&Node::declared_type)))->def_readwrite("scope", (&Node::scope)))->def_readwrite("source", (&Node::source)))->def("__repr__", (&Node::repr)))->def("ast_repr", [](const Node&  n) {
        ...
        auto class_def { ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(ceto::mado(py::class_<ClassDefinition,std::shared_ptr<ClassDefinition>>(m, "ClassDefinition"))->def(py::init<std::shared_ptr<const Identifier>,std::shared_ptr<const Call>,bool,bool,bool>(), py::arg("name_node"), py::arg("class_def_node"), py::arg("is_unique"), py::arg("is_struct"), py::arg("is_forward_declaration")))->def_readwrite("name_node", (&ClassDefinition::name_node)))->def_readwrite("class_def_node", (&ClassDefinition::class_def_node)))->def_readwrite("is_unique", (&ClassDefinition::is_unique)))->def_readwrite("is_struct", (&ClassDefinition::is_struct)))->def_readwrite("is_forward_declaration", (&ClassDefinition::is_forward_declaration)))->def_readwrite("is_concrete", (&ClassDefinition::is_concrete)))->def_readwrite("is_pure_virtual", (&ClassDefinition::is_pure_virtual)) } ;
        ceto::mado(py::class_<InterfaceDefinition,std::shared_ptr<InterfaceDefinition>>(m, "InterfaceDefinition", class_def))->def(py::init<>());
        auto variable_def { ceto::mado(ceto::mado(ceto::mado(py::class_<VariableDefinition,std::shared_ptr<VariableDefinition>>(m, "VariableDefinition"))->def(py::init<std::shared_ptr<const Identifier>,std::shared_ptr<const Node>>(), py::arg("defined_node"), py::arg("defining_node")))->def_readwrite("defined_node", (&VariableDefinition::defined_node)))->def_readwrite("defining_node", (&VariableDefinition::defining_node)) } ;
