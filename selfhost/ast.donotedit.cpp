...
[]( auto &&  m) {
        ...
        (*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad((*ceto::mad(py::class_<StringLiteral,ceto::propagate_const<std::shared_ptr<StringLiteral>>>(m, "StringLiteral", node))).def(py::init<const std::string &,std::optional<ceto::propagate_const<std::shared_ptr<const Identifier>>>,std::optional<ceto::propagate_const<std::shared_ptr<const Identifier>>>,const SourceLoc &>(), py::arg("str"), py::arg("prefix"), py::arg("suffix"), py::arg("source") = SourceLoc()))).def_readonly("str", (&StringLiteral::str)))).def_readwrite("prefix", (&StringLiteral::prefix)))).def_readwrite("suffix", (&StringLiteral::suffix)))).def("escaped", (&StringLiteral::escaped));
        (*ceto::mad((*ceto::mad((*ceto::mad(py::class_<IntegerLiteral,ceto::propagate_const<std::shared_ptr<IntegerLiteral>>>(m, "IntegerLiteral", node))).def(py::init<const std::string &,std::optional<ceto::propagate_const<std::shared_ptr<const Identifier>>>,const SourceLoc &>(), py::arg("integer_string"), py::arg("suffix"), py::arg("source") = SourceLoc()))).def_readonly("integer_string", (&IntegerLiteral::integer_string)))).def_readonly("suffix", (&IntegerLiteral::suffix));
        (*ceto::mad((*ceto::mad((*ceto::mad(py::class_<FloatLiteral,ceto::propagate_const<std::shared_ptr<FloatLiteral>>>(m, "FloatLiteral", node))).def(py::init<const std::string &,std::optional<ceto::propagate_const<std::shared_ptr<const Identifier>>>,const SourceLoc &>(), py::arg("float_string"), py::arg("suffix"), py::arg("source") = SourceLoc()))).def_readonly("float_string", (&FloatLiteral::float_string)))).def_readonly("suffix", (&FloatLiteral::suffix));
