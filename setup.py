...
#packaged_ceto_checked_array_access_header = os.path.join(rootdir, "ceto", "checked_array_access.cth")
packaged_ceto_checked_array_access_header = os.path.join(rootdir, "ceto", "ceto_checked_array_access.donotedit.autogenerated.h")

extra_packaged = [manifest, packaged_ceto_header, packaged_ceto_ast_header, packaged_ceto_utility_header, packaged_ceto_range_utility_header, packaged_ceto_visitor_header, packaged_ceto_checked_array_access_header]
...
try:
    ...
    #shutil.copyfile(os.path.join(rootdir, "include", "checked_array_access.cth"), packaged_ceto_checked_array_access_header)
    shutil.copyfile(os.path.join(rootdir, "include", "ceto_checked_array_access.donotedit.autogenerated.h"), packaged_ceto_checked_array_access_header)
