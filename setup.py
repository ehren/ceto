...
ext_modules = [
    Pybind11Extension("ceto._abstractsyntaxtree",
        ["selfhost/abstractsyntaxtree_pybind.donotedit.autogenerated.cpp",
        "selfhost/macros.donotedit.autogenerated.cpp"],  # Just build this here for now until pybind11 dependency removed from ast.cth header
